...
def thejuice():
    ...
    run("cp ./ubu18/common-password /etc/pam.d/common-password", shell=True)
    run("cp ./ubu18/cracklib.conf /etc/cracklib/cracklib.conf", shell=True)
    run("cp ./ubu18/login.defs /etc/login.defs", shell=True)
    print("done.")
